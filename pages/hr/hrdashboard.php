...
// Fetch Present and Absent counts per day (Updated for 4-punch system)
$att_query = "
    SELECT log_date, 
           SUM(CASE WHEN (morning_clock_in IS NOT NULL OR afternoon_clock_in IS NOT NULL) AND status != 'Absent' THEN 1 ELSE 0 END) as present_count,
