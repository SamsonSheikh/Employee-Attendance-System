<?php
// Run this script once in your browser to insert a test user into the SQL database
require_once __DIR__ . '/includes/db_connect.php';

$first_name = "Test";
$last_name = "Employee";
$email = "test.employee@flowtime.com"; // This will be the login username/email
$password = "SecurePass123!"; // Plain text password

// Securely hash the password using bcrypt
$password_hash = password_hash($password, PASSWORD_DEFAULT);

// Fallback values for foreign keys
$department_id = 1; 
$role_id = 3; // Typically 3 means Employee
$shift_id = 1;

// Ensure foreign key dependencies exist to prevent constraints from failing
$conn->query("INSERT IGNORE INTO roles (role_id, role_name) VALUES (1, 'admin'), (3, 'employee')");
...
echo "<h2>Database Setup: Add Test User</h2>";

if ($stmt->execute()) {
    echo "<div style='color: #155724; background-color: #d4edda; border: 1px solid #c3e6cb; padding: 15px; border-radius: 5px;'>";
    echo "<h3 style='margin-top:0;'>✅ User successfully inserted into the SQL database!</h3>";
