<?php
// Run this script once in your browser to insert a new standard employee user into the database
require_once __DIR__ . '/includes/db_connect.php';

$first_name = "Jane";
$last_name = "Smith";
$email = "jane.smith@flowtime.com"; // Login username
$password = "Welcome123!"; // Plain text password
...
if ($stmt->execute()) {
    ...
    echo "<h3 style='margin-top:0;'>✅ New Employee successfully added to the database!</h3>";
